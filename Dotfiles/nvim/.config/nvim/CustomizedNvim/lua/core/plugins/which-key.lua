...
local mappings = {
  ...
  f = {
    ...
    f = { '<cmd>Telescope find_files layout_strategy=horizontal<CR>', 'Files', },
...
local vmappings = {
  ['C'] = { "<cmd>lua require('Comment.api').toggle.linewise(vim.fn.visualmode())<CR>", 'Comment' },

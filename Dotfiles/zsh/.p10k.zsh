# Generated by Powerlevel10k configuration wizard on 2023-03-19 at 19:46 CET.
...
() {
  ...
  # Color if current directory.
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=$magenta

  # Context format when root: user@host. The first part white, the rest grey.
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_TEMPLATE="%F{$red}%n%f%F{$red}@%m%f"
